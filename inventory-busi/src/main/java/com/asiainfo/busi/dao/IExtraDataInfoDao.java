...
@Repository
public interface IExtraDataInfoDao {
	 ...
	 * @throws 
	 */
	public ExtraDataInfo selectByPrimaryKey(@Param("extraId") Integer extraId);
	 ...
	 * @throws 
	 */
    int deleteByPrimaryKey(@Param("extraId") Integer extraId);
